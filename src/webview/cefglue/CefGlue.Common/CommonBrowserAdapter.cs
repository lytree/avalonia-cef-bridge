...
namespace Xilium.CefGlue.Common
{
    internal class CommonBrowserAdapter : ICefBrowserHost, IDisposable
    {
        ...
        {
            throw new NotSupportedException("Reflection-based JavaScript object binding is disabled. Use Tarui IPC commands.");
        }
        ...
        private void OnWebMessageReceived(MessageReceivedEventArgs eventArgs)
        {
        ...
        {
            if (frame.IsMain) IsJavascriptEngineInitialized = false;
        }
